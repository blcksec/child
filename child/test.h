...
namespace Child {
    ...
    private slots:
        ...
        void prependModule() {
            ...
            QCOMPARE(obj->modules().size(), 1);
            QCOMPARE(obj->modules()[0], mod1);
            QCATCH(obj->prependModule(mod1), DuplicatedException);
            ...
            QCATCH(obj->prependModule(mod2), DuplicatedException);
            delete obj;
            delete mod1;
            delete mod2;
        }
        ...
        void addParent() {
            ...
            QCATCH(button1->addParent("button", window1), DuplicatedException);
            QCATCH(button2->addParent("button", window1), DuplicatedException);
        ...
        void inspect() {
            ...
            window->setChild("person1", person);
            window->setChild("person2", person);
            Module *first = new Module;
            Module *last = new Module;
            person->setChild("first_name", first);
            person->setChild("last_name", last);
